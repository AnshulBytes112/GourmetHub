...
public class VerifyUsers extends javax.swing.JFrame {
    ...
    public void getAllRecords(String email){
        ...
        while(itr.hasNext()){
            ...
            if(!userObj.getEmail().equals("admin@gmail.com")){
                ...
                dtm.addRow(new Object[]{userObj.getId(),userObj.getName(),userObj.getEmail(),userObj.getPhonenumber(),userObj.getAddress(),userObj.getStatus()});
            }
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(14, 17, 122, -1));

        jLabel3.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(51, 51, 51));
        jLabel3.setText("Search");
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(376, 117, 50, -1));
        ...
        getContentPane().add(txtsearch, new org.netbeans.lib.awtextra.AbsoluteConstraints(456, 114, 387, -1));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Name", "Email", "MobileNumber", "Address", "Status"
            }
        ));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(14, 186, 1335, 496));

        jLabel4.setFont(new java.awt.Font("SimSun-ExtG", 0, 36)); // NOI18N
        jLabel4.setText("Click on row to Change Status");
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(391, 708, 549, -1));
    ...
    private void formComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_formComponentShown
        ...
        getAllRecords("");//this will load all the details
